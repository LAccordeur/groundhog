...
#define MAX_DATA_TRANSFER_SIZE 8 /* 12 (4096 pages) not work well since spdk has a limitation of prp entries number which is 503 */

//#define CONFIG_DATA_CACHE_CAPACITY (512UL << 20) /* 512MB */
//#define CONFIG_DATA_CACHE_CAPACITY (2048UL << 20) /* 2048MB */
#define CONFIG_DATA_CACHE_CAPACITY (1024UL << 20) /* 1024MB */
